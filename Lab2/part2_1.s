...
/* r10 has the student number being searched */
	movia r11, result
	movia r10, 681936		# r10 is where you put the student number being searched for
...
loop:
	...
	ldw r8, (r13)	#load the grades corresponding to current student number

	beq r9, r0, notfound
	beq r9, r10, found
	
	addi r12, r12, 4	#increment to the next student number
	addi r13, r13, 4	#increment to the next student grades
	
	br loop	#branch back to the loop
found:
	stw r8, (r11)
	ldw r6, (r11)	#to see the contents of result
