...
IRQ_HANDLER:
        ...
        subi    sp, sp, 56         # make room on the stack
...
SKIP_EA_DEC:
        #stw     ea, 40(sp)  # storing the return address for the subroutine onto the stack
...
END_ISR:
        ...
        #ldw     ea, 40(sp)  # storing the return address for the subroutine onto the stack
...
KEY_ISR:
		# need to acknowlegde the key interupt
		movia r2, KEY_BASE
		movi r14, 0xF
		stwio r14, 12(r2)
